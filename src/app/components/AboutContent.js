...
export default function AboutContent() {
  ...
  return (
    ...
    <div className="mb-about-container">
            ...
            <h3>Reviews</h3>
            <p>When you click on <Link href="/allreviews">REVIEWS</Link>, itll bring you to a page with all current reviews from all existing users. Here, you can sort by review score, and access the full review by clicking on the READ FULL REVIEW button. A count of the number of reviews on our app will be displayed at the bottom of the page.</p><br/>
            <h3>Profiles</h3>
